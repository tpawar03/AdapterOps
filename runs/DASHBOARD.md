...
Sources: `runs/regression__v1-baseline-1.json` · `runs/regression__v1-baseline-2.json` · `evals/GATE_THRESHOLDS.json` · `runs/m1_serving.json` · `runs/router__latency.json` · `runs/economics.json` · `runs/router__operating_curve__judged.json` · `runs/router__v2.json` · `runs/router__rules.json` · `runs/router__misroutes.json` · `runs/judge__cost.json` · `runs/frontier__golden.json` · `runs/drafting__m2_gpt4o__frontier.json` · `runs/drafting__m2_gpt4o.json` · `runs/regression__intent-shuffled.json` · `runs/regression__all-m11.json` · `manifests/system.json` · `runs/request_path__a10-v4.json` · `runs/regression__a10-v4.json` · `runs/request_path__a10-v4-shift.json` · `runs/request_path__a10-v4-sweep.json` · `runs/request_path__a10-v4-sweep-vllm.json` · `runs/request_path__a10-v4-sustained.json` · `runs/pii__false_positives.json`
